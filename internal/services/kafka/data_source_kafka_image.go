...
func NewKafkaImageDataSource() datasource.DataSource {
...
func (d KafkaImageDataSource) Metadata(
	...
	resp.TypeName = req.ProviderTypeName + "_kafka_image_data"
}

func (d *KafkaImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
