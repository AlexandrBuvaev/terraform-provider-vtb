...
func NewAirflowImageDataSource() datasource.DataSource {
...
func (d AirflowImageDataSource) Metadata(
	...
	resp.TypeName = req.ProviderTypeName + "_airflow_image_data"
}

func (d *AirflowImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
