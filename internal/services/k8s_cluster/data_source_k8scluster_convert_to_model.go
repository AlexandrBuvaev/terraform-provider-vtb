...
func ConvertRegionToModel(data entities.K8sConfigRegion, isClusterRegion bool) K8sClusterRegionModel {
...
func ConvertRegionComponentsToModel(data *entities.K8sConfigRegionComponents) *K8sClusterRegionComponentsModel {
...
func ConvertIngressToModel(data entities.K8sConfigIngress, isClusterIngress bool) K8sClusterIngressModel {
	var iscodes basetypes.ListValue
	if isClusterIngress {
		elements := make([]attr.Value, len(data.IsCodes))
		for i, code := range data.IsCodes {
...
func ConvertTcpUdpToModel(data []entities.K8sConfigIngressTcpUdp) []K8sClusterIngressTcpUdpModel {
...
func ConvertIngressFeaturesToModel(data *entities.K8sConfigIngressFeatures) *K8sClusterIngressFeaturesModel {
	if data == nil {
		return nil
	}
...
func ConvertGslbOnlyToModel(data *bool) types.Bool {
	if data == nil {
		return types.BoolNull()
	} else {
		return types.BoolPointerValue(data)
	}
