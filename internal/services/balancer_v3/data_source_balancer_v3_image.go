...
func NewBalancerV3ImageDataSource() datasource.DataSource {
...
func (d BalancerV3ImageDataSource) Metadata(
	...
	resp.TypeName = req.ProviderTypeName + "_balancer_v3_image_data"
}

func (d *BalancerV3ImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
