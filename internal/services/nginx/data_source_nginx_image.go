...
var (
	_ datasource.DataSource = &NginxImageDataSource{}
)

type NginxImageDataSource struct {
	client *client.CloudClient
}

func NewNginxImageDataSource() datasource.DataSource {
	return &NginxImageDataSource{}
}

func (d NginxImageDataSource) Metadata(
	ctx context.Context,
	req datasource.MetadataRequest,
	resp *datasource.MetadataResponse,
) {
	resp.TypeName = req.ProviderTypeName + "_nginx_image_data"
}

func (d *NginxImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (t NginxImageDataSource) Schema(
	ctx context.Context,
...
func (d NginxImageDataSource) Read(
	ctx context.Context,
	...
	image, err := references.GetNginxImageData(
		d.client.Creds,
