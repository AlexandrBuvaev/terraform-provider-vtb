...
func NewDebeziumImageDataSource() datasource.DataSource {
...
func (d *DebeziumImageDataSource) Metadata(
	...
	resp.TypeName = req.ProviderTypeName + "_debezium_image_data"
}

func (d *DebeziumImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
