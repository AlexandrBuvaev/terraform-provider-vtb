...
func NewClickhouseClusterImageDataSource() datasource.DataSource {
...
func (d ClickhouseClusterImageDataSource) Metadata(
	...
	resp.TypeName = req.ProviderTypeName + "_clickhouse_cluster_image_data"
}

func (d *ClickhouseClusterImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
