...
func NewAgentOrchestrationImageDataSource() datasource.DataSource {
...
func (d AgentOrchestrationImageDataSource) Metadata(
	...
	resp.TypeName = req.ProviderTypeName + "_agent_orchestration_image_data"
}

func (d *AgentOrchestrationImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
