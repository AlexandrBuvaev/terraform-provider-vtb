...
func NewPostgresqlImageDataSource() datasource.DataSource {
...
func (d PostgresqlImageDataSource) Metadata(
	...
	resp.TypeName = req.ProviderTypeName + "_postgresql_image_data"
}

func (d *PostgresqlImageDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d PostgresqlImageDataSource) Read(
	...
	if d.client.Environment == "PROD" && data.ProductType.ValueString() != "cluster" {
	...
	var err error
	if strings.EqualFold(d.client.EnvironmentName, "lt") && strings.EqualFold(data.ProductType.ValueString(), "cluster") {
