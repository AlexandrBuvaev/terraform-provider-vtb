...
const testAccAstraLinuxImageConfig = `
data "vtb_compute_image_data" "test" {
	distribution       = "astra"
	os_version         = "1.7"
}
`

func TestAccReferenceAstraLinuxImageDataSource(t *testing.T) {

	dataSourceName := "data.vtb_compute_image_data.test"

	resource.Test(t, resource.TestCase{
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: providerConfig + testAccAstraLinuxImageConfig,
