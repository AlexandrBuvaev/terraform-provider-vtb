...
const testAccRabbitMQImageConfig = `
...
func TestAccReferenceRabbitMQImageDataSource(t *testing.T) {

	dataSourceName := "data.vtb_rabbitmq_image_data.test"

	resource.Test(t, resource.TestCase{
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: providerConfig + testAccRabbitMQImageConfig,
