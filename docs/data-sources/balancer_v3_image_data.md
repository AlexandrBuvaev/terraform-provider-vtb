...
page_title: "vtb_balancer_v3_image_data Data Source - terraform-provider-vtb"
subcategory: ""
description: |-
  Данные образа из сервиса справочников необходимые для оформления заказа.
---

# vtb_balancer_v3_image_data (Data Source)
...
```terraform
data "vtb_balancer_v3_image_data" "balancer_v3_image" {
	distribution    = "astra"
	os_version      = "1.7"
}
```
