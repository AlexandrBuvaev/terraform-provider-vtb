...
page_title: "vtb_redis_sentinel_image_data Data Source - terraform-provider-vtb"
subcategory: ""
description: |-
  Type of Redis Sentinel instance
---

# vtb_redis_sentinel_image_data (Data Source)
...
```terraform
data "vtb_redis_sentinel_image_data" "img" {
	distribution    = "astra"
	os_version      = "1.7"
}
```
